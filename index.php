    ...
    <div class="container-fluid">
        <div class="row pt-5 row-gap-2">
            <div class="col-sm-12 col-lg-5 text-white ">
                ...
                <a href="./album_gallery.php" class="link-light link-offset-2 link-underline-opacity-0"><button type="button" class="btn  rounded-0 btn-lg home-btn fs-5 fw-bold text-white">Buy a Car</button></a>
            ...
            <div class="col-sm-12 col-lg-7 home-car"><img src="./assets/images/4-2-car-png-hd 1.png" alt="" height="100%" width="100%"></div>
        </div>
    </div>
        ...
        <div class="row row-cols-1 justify-content-center row-cols-lg-3 g-5 buy-sale-content">
            <div class="col">
                <div class="card border-0 shadow-sm h-100 rounded-5">
                    <img src="./assets/images/buy-sell/Rectangle 519.png" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card border-0 shadow-sm h-100 rounded-5">
                    <img src="./assets/images/buy-sell/Rectangle 519 (1).png" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card border-0 shadow-sm h-100 rounded-5">
                    <img src="./assets/images/buy-sell/Rectangle 519 (2).png" class="card-img-top" alt="...">
                    <div class="card-body">
        ...
        <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-12  g-5">
            <div class="col">
                <div class="card rounded-5 border-0 shadow-sm  h-100 ">
                    <img src="./assets/images/featured-images/Rectangle 516.png" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card rounded-5 border-0 shadow-sm h-100 ">
                    <img src="./assets/images/featured-images/Rectangle 516 (1).png" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card rounded-5 border-0 shadow-sm h-100 ">
                    <img src="./assets/images/featured-images/Rectangle 516 (2).png" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card rounded-5 border-0 shadow-sm h-100 ">
                    <img src="./assets/images/featured-images/Rectangle 516 (3).png" class="card-img-top" alt="...">
                    <div class="card-body">
    ...
    <div class="container">
        <div class="row row-cols-1 row-cols-lg-4 justify-content-center g-5">
            <div class="col service-col">
                ...
                service-con">
                    <div class="position-relative service-img">
                        <img src="./assets/images/service-image/Rectangle 10.png" class="card-img-top" alt="...">
                        <img src="./assets/images/service-image/icons8_buy.png" class="position-absolute service-logo" alt="">
                    </div>
                    <div class="card-body">
            ...
            <div class="col service-col">
                ...
                service-con">
                    <div class="position-relative service-img">
                        <img src="./assets/images/service-image/Group 454.png" class="card-img-top" alt="...">
                    </div>
                    <div class="card-body">
            ...
            <div class="col service-col">
                ...
                service-con">
                    <div class="position-relative service-img">
                        <img src="./assets/images/service-image/Rectangle 10.png" class="card-img-top" alt="...">
                        <img src="./assets/images/service-image/Group 1597882551.png" class="position-absolute service-logo" alt="">
                    </div>
                    <div class="card-body">
...
<div class="container-fluid app-car">
    <div class="row row-gap-5">
        ...
        <div class="col-sm-12 col-lg-6 app-car-img"><img src="./assets/images/car-app/Rectangle 46.jpg" class="pt-5" alt=""></div>
    </div>
</div>
